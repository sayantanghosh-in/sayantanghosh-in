...
export default async function Login() {
  return (
    <div>
      ...
      />
      <section className="mt-4 md:mt-16 flex justify-center items-center px-2 md:px-32 lg:px-96">
        <Suspense>
          <LoginForm />
        </Suspense>
      </section>
      <section className="flex justify-center mt-2 px-2 md:px-32 lg:px-96">
